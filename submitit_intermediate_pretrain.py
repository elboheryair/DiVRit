...
from configs.config_maps import MODEL_PROTOTYPE_CONFIGS, INTERMEDIATE_CONFIGS
...
class SubmititTrainingArguments:
    ...
    intermediate_training_config_name: Optional[str] = field(default=None, metadata={"help": "Name of the training config to use"})
...
class Trainer:
    ...
    def __call__(self):
        import scripts.training.run_intermediate_pretraining as trainer
...
def get_config_dict(**kwargs):
    ...
    # Training config
    intermediate_training_config_name = kwargs.pop("intermediate_training_config_name")
    if intermediate_training_config_name:
        training_config = load_json(INTERMEDIATE_CONFIGS[intermediate_training_config_name])
