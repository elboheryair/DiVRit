...
class PangoCairoTextRenderer(TextRenderingMixin):
    ...
    def _render_single_sentence(
        ...
        # if layout.get_unknown_glyphs_count() > 0: # todo my change
        #     logger.warning(
        ...
        # width, height = layout.get_pixel_size()
        if width > 8464:
            position = (8464-width-16-offset, position[1])
        # else:
        #     position = (16-offset, position[1])
        context.move_to(*position)
    ...
    def _render_text_to_surface(
        ...
        **kwargs,
        ...
        context, (_, layout), text_width = self._render_single_sentence(text, offset, context, rtl=kwargs['rtl']) # todo my change
