...
from configs.config_maps import MODEL_PROTOTYPE_CONFIGS, TRAINING_CONFIGS, MM_CONFIGS
...
class Trainer:
    ...
    def __call__(self):
        import scripts.training.run_MM_diacritizer as trainer
...
def get_config_dict(**kwargs):
    ...
    if finetuning_config_name:
        training_config = load_json(MM_CONFIGS[finetuning_config_name])
...
'''
python submitit_mm_finetune.py \
	--job_dir diacritics/diacritizing/mm_finetuning/base/ \
