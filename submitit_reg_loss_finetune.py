...
from configs.config_maps import MODEL_PROTOTYPE_CONFIGS, TRAINING_CONFIGS, REG_LOSS_CONFIGS
...
class Trainer:
    ...
    def __call__(self):
        import scripts.training.run_reg_loss_diacritizer as trainer
...
def get_config_dict(**kwargs):
    ...
    if finetuning_config_name:
        training_config = load_json(REG_LOSS_CONFIGS[finetuning_config_name])
