...
from configs.config_maps import MODEL_PROTOTYPE_CONFIGS, TRAINING_CONFIGS, MODELING_DIACRITICS_CONFIGS
...
class Trainer:
    ...
    def __call__(self):
        import scripts.training.run_modeling_diacritics_training as trainer
...
def get_config_dict(**kwargs):
    ...
    if training_config_name:
        training_config = load_json(MODELING_DIACRITICS_CONFIGS[training_config_name])
